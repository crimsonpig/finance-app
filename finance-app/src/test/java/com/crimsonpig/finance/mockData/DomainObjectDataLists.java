...
public class DomainObjectDataLists {
	...
	public List<Transaction> getTransactionItems(){
		...
		transactions.add(new Transaction("GAS", LocalDate.of(2016, 3, 2), "E", new BigDecimal(26.08)));
		transactions.add(new Transaction("HOUSEHOLD", LocalDate.of(2016, 3, 2), "E", new BigDecimal(5.97)));
		transactions.add(new Transaction("EATING OUT", LocalDate.of(2016, 3, 8), "E", new BigDecimal(18.96)));
		transactions.add(new Transaction("HOUSEHOLD", LocalDate.of(2016, 3, 8), "E", new BigDecimal(10.18)));
